    ...
    <div className="min-h-screen bg-[#FBF9F8]">
      ...
      <aside className="hidden md:fixed md:inset-y-0 md:left-0 md:w-64 md:flex md:flex-col sidebar">
        ...
        <div className="p-4 border-t border-stone-200">
          <button onClick={logout} className="w-full flex items-center gap-3 px-2 py-2 text-[#50453B] hover:opacity-70 transition-all">
      ...
      <div
        onClick={close}                             // ✅ Cierra al tocar fuera
        className={`
      ...
      <aside
        className={`
          ...
          ${open ? 'translate-x-0' : '-translate-x-full'}  // ✅ Animación suave
        `}
      >
        <button
          onClick={close}
