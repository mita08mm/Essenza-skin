...
export function Footer({ config }: FooterProps) {
  ...
  const socialLinks = [
    {
      name: 'Facebook',
      url: 'https://www.facebook.com/profile.php?id=61588577154941',
      icon: (
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/dra.cecilearcederpic/',
      icon: (
        <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor">
    ...
    {
      name: 'TikTok',
      url: 'https://www.tiktok.com/@essenzadra.cecile',
      icon: (
        <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor">
            ...
            <div className="flex gap-3">
              {socialLinks.map((social, i) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-10 w-10 items-center justify-center rounded-full transition-all hover:opacity-80"
